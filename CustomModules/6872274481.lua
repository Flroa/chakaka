...
--nigga chakaka
---- hi
-- credits for inf yeild for blink!!1
-- credit for dev form for math?
...
runFunction(function()
    ...
    Multiaura = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		...
		["HoverText"] = "Not confirmed to be better then v1 its just a dif multiaura"
    })
end)
...
game:GetService("UserInputService").JumpRequest:connect(function()
    ...
    Default = false,
    HoverText = "Risky Inf Jump nagger"
})
...
Notify('Yay!!!', 'Chakaka v3 beta has officaly looaded!!!', 4)
Notify('Hello', 'do your prayers pls', 4)